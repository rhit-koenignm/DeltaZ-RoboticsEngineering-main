/**
 * @file DeltaZ_communication.ino
 * @author Sam Alvares, Pragna Mannam, Dr. Oliver Kromer, Dr. Zeynep Temel
 * @brief Example arduino file for the use of the DeltaZ Arduino library established by the
 * authors for use of the DeltaZ robot.
 * @version 0.1
 * @date 2022-05-15
 * 
